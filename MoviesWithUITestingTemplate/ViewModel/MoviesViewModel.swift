...
final class MoviesData: ObservableObject {
    ...
    func AddMovie(title: String, director: String, pitch: String, year: Int, genre: Genre) {
        movies.append(Movie(title: title, director: director, image: "", pitch: pitch, year: Int(year), genre: genre, isFavorite: false))
    }
